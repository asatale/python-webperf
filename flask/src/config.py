...
parser = argparse.ArgumentParser(description='Python WSGI web-server')

parser.add_argument('-addr', type=str, default='0.0.0.0:8000',
                    help='Server bind address. Default: 0.0.0.0:8000')
